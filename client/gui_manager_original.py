    ...
    def _update_local_video_extreme(self, frame):
        ...
        try:
            ...
            if frame is not None and frame.size > 0:
                ...
                # Fast resize with nearest neighbor for speed - 80% slot coverage
    ...
    def _update_local_video_safe(self, frame, client_key):
        ...
        try:
            ...
            if frame is not None and frame.size > 0:
                ...
                # Resize to fit in video slot (maintain aspect ratio) - 80% slot coverage
                display_size = (320, 240)  # Larger size for 80% slot coverage
